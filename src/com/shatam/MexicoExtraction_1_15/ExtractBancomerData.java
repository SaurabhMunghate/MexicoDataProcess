...
//				if(!stateData[3].contains("20198"))continue;
				...
				//metodo=getPuntos&latitud=21.894764&longitud=-102.2479968&idOpcionCatalogo=4&idOpcionAtributo=&dia=1&hora=12%3A57&ubicacion=0&direccion=1&fecha=2020-08-31+12%3A57%3A439
//				String postData="metodo=getPuntos&latitud="+stateData[7]+"&longitud="+stateData[8]+"&idOpcionCatalogo=4&idOpcionAtributo=10&dia=1&hora=12%3A52&ubicacion=0&direccion=1&fecha=2020-08-31+12%3A52%3A831";
				String postData="metodo=getPuntos&latitud="+stateData[7]+"&longitud="+stateData[8]+"&idOpcionCatalogo=4&idOpcionAtributo=&dia=1&hora=12%3A57&ubicacion=0&direccion=1&fecha=2020-08-31+12%3A57%3A439";
//				U.log(postData);
