...
public class ExtractBanamex {
	...
	public static void main(String[] args) {
		...
		String postData[]= {"{\"site\":\"5\",\"entity\":\"bnmx_sucursales_summary\",\"options\":\"tipo.numero=100,tipo.numero=110\",\"quadrant\":\"33.34354203011677 -115.14459371566772 15.138870032533317 -86.95367574691772\",\"logicalOperator\":\"OR\",\"single\":\"true\"}",
				"{\"site\":\"5\",\"entity\":\"bnmx_sucursales_summary\",\"options\":\"tipo.numero=100,tipo.numero=300\",\"quadrant\":\"36.31882403712533 -123.40631246566772 18.60765054323039 -95.21539449691772\",\"logicalOperator\":\"OR\",\"single\":\"true\"}",
				"{\"site\":\"5\",\"entity\":\"bnmx_sucursales_summary\",\"options\":\"tipo.numero=100,tipo.numero=300\",\"quadrant\":\"28.59248092337254 -111.25241097085234 9.727466416817453 -83.06149300210234\",\"logicalOperator\":\"OR\",\"single\":\"true\"}",
				"{\"site\":\"5\",\"entity\":\"bnmx_sucursales_summary\",\"options\":\"tipo.numero=100,tipo.numero=300\",\"quadrant\":\"30.21884773098787 -109.64840706460234 21.183900141147582 -95.55294808022734\",\"logicalOperator\":\"OR\",\"single\":\"true\"}"};
...
//			U.log(postHtml);
			String postDataSecs[]=U.getValues(postHtml, "{\"servicios\"", ",\"estatus\":");
...
//					post=post.replaceAll("tipo.numero=\\d{3}\"", "tipo.numero="+services[i]+"\"");
			...
			postDataSecs=U.getValues(postHtml, "{\"servicios\"", ",\"estatus\":");
...
//						continue;
					...
					if (detailDataHtml.contains("\"result\":[],")||detailDataHtml.contains("\"Error\":\"Error al obtener código html")) {
