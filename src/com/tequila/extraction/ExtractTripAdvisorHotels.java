...
//			}
	...
	private void getHotelsList(String RegionUrlSec) throws Exception {
		...
		String hotelsUrl[]=U.getValues(hoteUrlSec, "ui_column is-4 thumbnail-column", "\"hotels_h_price_comparison_message_lt");
...
//			U.log(zip);
			...
			if (state!=null&&state.equals("Mexico City")) {
...
//			String add[]=JsonGoogleApiLatlonExtraction.testJsonCode(add)
		...
		if (city!=null &&latLon[0]!=ALLOW_BLANK&&latLon[0]!=null&&latLon[0].length()>4) {
