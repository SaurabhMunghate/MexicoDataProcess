...
public class ExtractItleon {
	...
	static String mainUrl="http://www.itleon.edu.mx";
	static String deptPath[]= {"https://www.itleon.edu.mx/index.php?option=com_content&view=article&id=1&Itemid=104"};
	final static String compnanyName="Instituto Tecnológico De León";
	final static String mainFax="477-711-2072";
	final static String openedIn="2009";
	final static String empCount=null;
	final static String[] add= {"Av. Tecnológico S/N","Fracc. Industrial Julián de Obregón","León","Guanajuato","37290"};
	final static String latLon[]= {"21.109249","-101.628048"};
	static String mainPhone= "477-710-5200";
...
//			U.log(listingSec);
			FileUtil.writeAllText(U.getCachePath()+"Instituto_Tecnologico_De_Leon.csv", sw.toString());
			sw.close();
			writer.close();
		} catch (IOException e) {
			e.printStackTrace();
