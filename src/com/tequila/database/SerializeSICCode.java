...
public class SerializeSICCode {
	
	public static HashMap<String,String[]> sicMap = new HashMap();
	
	public static void main(String[] args) throws Exception {
		
		serializedSicData("/home/glady/MexicoCache/sic_source/updateSiCCodeFile.csv");
	}
	public static void serializedSicData(String path) throws Exception
	{
		...
		try {
	        ...
	        FileOutputStream fileOut =new FileOutputStream("/home/glady/MexicoCache/sic_source/updateSicCodeData.ser");
